...
public class TelaGenio extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TelaGeniu
     */
    public TelaGenio() {
        initComponents();
        lblFrase.setText("<html>Vou pensar em um numero de<strong> 1 a 5</strong></html>");
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblFrase, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 30, 130, 80));
        ...
        getContentPane().add(txtVal, new org.netbeans.lib.awtextra.AbsoluteConstraints(76, 228, 70, -1));

        jLabel4.setText("Valor");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 50, 20));
        ...
        getContentPane().add(btnPalpite, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 290, 140, 30));
    ...
    private void btnPalpiteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPalpiteActionPerformed
        ...
        double n =  1 + Math.random() * (6 - 1); //Para sotear numeros de 1 a 5
        int valor = (int) n;
        int palpite = Integer.parseInt(txtVal.getValue().toString());
        
        String f1 = "<html>ACERTOU !!</html>";
        String f2 = "<html>ERROU !! Eu estava pensando em "+ valor + "</html>";
